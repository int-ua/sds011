...
from PyQt5.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QApplication, \
    QSizePolicy, QLabel, QGridLayout, QLineEdit, QPushButton, QRadioButton, \
...
class PlotCanvas(FigureCanvas):
    ...
    def plot(self, init_legend=False):
        ...
        self.ax.plot(
            self.timestamps, self.pm2_5vals, 'r-', label="pm2.5 µg/m³")
        self.ax.plot(
            self.timestamps, self.pm10vals, 'g-', label="pm10 µg/m³")

        # quick hack to counter multiple instances of legend
